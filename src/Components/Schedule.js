...
const Schedule = () => {
  ...
  return (
    <div className="schedule-container" style={{ marginTop: '10vh', textAlign: 'center', boxShadow: 'rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px', padding:'2vh', background:'#fafafa', }}>
      <h2 style={{ fontSize: '3rem', background: 'linear-gradient(black, blue)',
        backgroundClip: 'text',
        WebkitTextFillColor: 'transparent', }}>Syllabus</h2>
      <table
        style={{
          width: "80%",
          margin: "0 auto",
      ...
      <div style={{
        ...
        marginTop: '5vh',
        flexWrap: 'wrap'
      }}><h1 style={{background: 'linear-gradient(blue, black)',
      backgroundClip: 'text',
      WebkitTextFillColor: 'transparent',}}>PRIZES For Top 3 Performers In Every Course
        </h1><h1 style={{background: 'linear-gradient(black, blue)',
        backgroundClip: 'text',
        WebkitTextFillColor: 'transparent',}}>
        Get Certified By Joining The Best Internship
      </h1>
      <a href="https://forms.gle/EYDz9tTzWM4AvGCa7" target="_blank"><button className="secondary-button" >
          Register
        </button></a></div>
    </div>
  );
